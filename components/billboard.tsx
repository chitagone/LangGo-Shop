...
const Billboard: React.FC<BillboardProp> = ({ data }) => {
  return (
    <div className="relative p-2 sm:p-4 lg:p-6 rounded-xl overflow-hidden transition-transform transform group h-48 sm:h-64 lg:h-80 m-6">
      <div
        style={{ backgroundImage: `url(${data?.imageUrl})` }}
        className="rounded-xl absolute inset-0 bg-cover bg-center transition-transform duration-500"
      >
        <div className="absolute inset-0 bg-black/40 flex justify-center items-center text-center transition-opacity duration-300 ">
